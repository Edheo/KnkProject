...
namespace KnkScrapers.Classes
{
    ...
    {
        public List<Movie> FindMovies(KnkSolutionMovies.Entities.File aFile, string aLanguage)
        {
        ...
        public async Task<List<Movie>> FindMoviesTsk(KnkSolutionMovies.Entities.File aFile, string aLanguage)
        {
